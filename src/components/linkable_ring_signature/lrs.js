...
import {getRandomInt,genKeyPair,publicKeyToHex,hexToPublicKey,hash1,hash2,concateArray,pointToInt,messageToInt} from './utils.js';
...
export function test(){
    ...
    let identity = 0;   // signer's public key index
    let message = "1";
    let message2 = "abc";
